...
if __name__ == '__main__':
    ...
    for f2 in File_2_dict:
        ...
        for f1 in File_1_dict:
            if f2 in f1:
                d = File_2_dict[f2]
                d['source'] = File_1_dict[f1]['path']
                report[f2] = d
                found = True
                break
        if not found:
            d = File_2_dict[f2]
            d['source'] = "Not found on Art Server"
            report[f2] = d
