...
if __name__ == '__main__':
    ...
    report_path = root_path + 'xbr_paid_gifting_Assets_Folder_list.csv'

    assets_to_download =root_path + 'paid_gifting.csv'
    ...
    data =folderList(myAssetsList,targetPaths,ldt)
